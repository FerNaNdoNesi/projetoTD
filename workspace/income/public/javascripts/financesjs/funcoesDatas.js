...
Author: Rob Eberhardt, Slingshot Solutions - http://slingfive.com/pages/code/jsDate/jsDate.js
...
// arrays (1-based)
Date.MonthNames = [null,'Janeiro','Fevereiro','Março','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'];
Date.WeekdayNames = [null,'Domingo','Segunad','Terça','Quarta','Quinta','Sexta','Sábado'];
...
// var today= new Date(2001, 10,1);
// console.log('Months since the new millenium: ' + Date.DateDiff('yyyy', y2k, today)); //displays 143